...
var symbolicNames = [ null, "DEF", "RETURN", "IF", "ELIF", "ELSE", "WHILE", 
                      ...
                      "MOD_ASSIGN", "SKIP_", "UNKNOWN_CHAR", "INDENT", "DEDENT" ];
...
Python3Parser.NOT_EQ = 38;
Python3Parser.ADD_ASSIGN = 39;
Python3Parser.SUB_ASSIGN = 40;
Python3Parser.MULT_ASSIGN = 41;
Python3Parser.DIV_ASSIGN = 42;
Python3Parser.MOD_ASSIGN = 43;
Python3Parser.SKIP_ = 44;
Python3Parser.UNKNOWN_CHAR = 45;
Python3Parser.INDENT = 46;
Python3Parser.DEDENT = 47;
...
Python3Parser.prototype.augassign = function() {
    ...
    try {
        ...
        this.state = 131;
        _la = this._input.LA(1);
        if(!(((((_la - 39)) & ~0x1f) == 0 && ((1 << (_la - 39)) & ((1 << (Python3Parser.ADD_ASSIGN - 39)) | (1 << (Python3Parser.SUB_ASSIGN - 39)) | (1 << (Python3Parser.MULT_ASSIGN - 39)) | (1 << (Python3Parser.DIV_ASSIGN - 39)) | (1 << (Python3Parser.MOD_ASSIGN - 39)))) !== 0))) {
...
Python3Parser.prototype.comparison = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(((((_la - 33)) & ~0x1f) == 0 && ((1 << (_la - 33)) & ((1 << (Python3Parser.LESS_THAN - 33)) | (1 << (Python3Parser.GREATER_THAN - 33)) | (1 << (Python3Parser.EQUALS - 33)) | (1 << (Python3Parser.GT_EQ - 33)) | (1 << (Python3Parser.LT_EQ - 33)) | (1 << (Python3Parser.NOT_EQ - 33)))) !== 0)) {
            this.state = 198;
            this.comp_op();
            this.state = 199;
            this.expr();
...
Python3Parser.prototype.comp_op = function() {
    ...
    try {
        ...
        this.state = 206;
        _la = this._input.LA(1);
        if(!(((((_la - 33)) & ~0x1f) == 0 && ((1 << (_la - 33)) & ((1 << (Python3Parser.LESS_THAN - 33)) | (1 << (Python3Parser.GREATER_THAN - 33)) | (1 << (Python3Parser.EQUALS - 33)) | (1 << (Python3Parser.GT_EQ - 33)) | (1 << (Python3Parser.LT_EQ - 33)) | (1 << (Python3Parser.NOT_EQ - 33)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
